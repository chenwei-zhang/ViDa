...
def sim_loop(seq,N,NUM_SIM=1,ATIME_OUT=ATIME_OUT,Temp=Temp,
    substrate_type=substrate_type,FAIL="OFF"):
    ...
    while n < N:
        ...
        sys.stdout = open("../output_data/helix_assoc_{}/assoc_{}_{}sim_{}C_{}.txt".format(seq,seq,NUM_SIM,Temp,n), "w")
...
# seq = "PT4_hairpin"
seq = "PT0"
o = sim_loop(seq,N=100)  # Run sim loops
