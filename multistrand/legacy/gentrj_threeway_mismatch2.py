...
def create_setup():
    ...
    bm_design_mm2 = "GGTGAGTTTGAGGTTCA"
    incum_extra_design = "TGGTGTTTGTGGGTGT"
    bm_design_parttgt = "GGTGAGTTTGAGGTTGA"

    # creating Domain objects
    toehold = Domain(name="toehold", sequence=toehold_seq[0:toehold_length])
    branch_migration_inv = Domain(name="bm", sequence=bm_design_mm2)
...
if __name__ == '__main__':
    ...
    for i in range(2):
        ...
        sys.stdout = open(f"./raw_data/Machinek-Mismatch2-og/Machinek-Mismatch2-{i}.txt", "a")
