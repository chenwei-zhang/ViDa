...
from utils import read_data, assign_base_names, load_raw_data
...
def main():
    ...
    if 'gao' in reaction_id.lower():
        ...
        inpath = "data/raw_data/machinek_data"
        outpath = "data/post_data/{}/{}.pkl.gz".format(reaction_id, reaction_id)
    ...
    trajs_states,trajs_times,trajs_energies,trajs_ids = read_data(
                                                    fpath,
                                                    num_traj
                                                    )
