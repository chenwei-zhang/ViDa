...
def get_uniq(dp, dp_og, energy, pair):
    ...
    return dp_uniq, dp_og_uniq, energy_uniq, pair_uniq, indices_uniq, indices_all
...
def readout_3strand_txt(lines, ref_name_list, strand_list, strand_sub, strand_incb, strand_inv):
...
def read_machinek_txt(fpath, rxn, ref_name_list, strand_list, strand_sub, strand_incb, strand_inv, num_files):
    ...
    for i in range(num_files):
        ...
        trj = readout_3strand_txt(lines, ref_name_list, strand_list, strand_sub, strand_incb, strand_inv)
...
def read_machinek(inpath, rxn, num_traj):
    ...
    return trajs_states, trajs_times, trajs_energies
...
def concat_machinek(states, times, energies):
    ...
    return dp, dp_og, energy, trans_time
