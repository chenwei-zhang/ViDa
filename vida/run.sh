...
# python read_machineck.py --inpath ../../data/raw_data/Machinek-data/Machinek-PRF --rxn Machinek-PRF --num-files 224 --outpath ../../data/post_data/Machinek-PRF/Machinek-PRF.pkl.gz
